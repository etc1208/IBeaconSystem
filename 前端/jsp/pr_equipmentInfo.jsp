...
<html lang="en">
  <head>
    ...
    <style>
		...
		#uploadExcelBtn,#conditionalSearchBtn{
			float: right;
			margin-right: 4px;
		}
            ...
            <div class="panel panel-default">
   				<div class="panel-heading" role="tab" id="sessionPanel">
      				<h4 class="panel-title">
       	 				<a role="button" data-toggle="collapse" href="#BeaconAlluse" aria-expanded="true" aria-controls="sessionCollapse">
          					设备使用情况 <span class="glyphicon glyphicon-hand-down" aria-hidden="true"></span>
        				</a>
      				</h4>
   		 		</div>
   				 <div id="BeaconAlluse" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="sessionPanel">
      				<div class="panel-body">
						<table class="table table-bordered table-condensed" id="BeaconAlluse_table">                             
                        	<thead>
                            	<tr>
                                   	<th>绑定比例</th>
                                   	<th>未使用比例</th>                        
                ...
                <div class="box col-md-12" style="margin-top:20px">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            ...
                            <button type="button" class="btn btn-info btn-sm" id='uploadExcelBtn' data-toggle="modal" data-target="#uploadExcelModal"><i class="glyphicon glyphicon-share"></i> 导入配置信息Excel</button>
                            <button type="button" class="btn btn-warning btn-sm" id='conditionalSearchBtn'><i class="glyphicon glyphicon-zoom-in"></i> 更多搜索</button>               
                        </div>
                        ...
                        <div class="box-content" id="test">
                            ...
                            <table class="table table-striped table-bordered table-condensed" id="equipmentTable">
                                ...
                                <tbody>
				<tr><td>无</td><td>无</td><td>无</td><td>无</td><td>无</td><td>无</td><td>无</td><td>无</td><td>无</td><td>无</td><td>无</td><td>无</td><td>无</td><td>无</td><td>无</td></tr>
                                </tbody>
                            </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">配置信息Excel导入</h4>          
            </div>
           <form role="form" action="url!add" method="post" id="uploadExcel_form" >
           	<div  class="modal-body">
               <input type="file" class="form-control" id="excelFile" name="upload">  
               <span style="color:red;">备注：仅支持xls格式的文件</span>              
            </div>
...
<div class="modal fade bs-example-modal-lg" id="showBaiduMapModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-body" >
                    <form class="form-horizontal" role="form">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-9"><input type="text" class="form-control" id="condition_uuid" ></div>
                        </div>

                        <div class="form-group form-group-sm">
                            <label class="col-md-3 control-label">Major</label>
                            <div class="col-md-9"><input type="text" class="form-control " id="condition_major" ></div>
                        </div>

                        <div class="form-group form-group-sm">
                            <label class="col-md-3 control-label">Minor</label>
                            <div class="col-md-9"><input type="text" class="form-control " id="condition_minor" ></div>
                        </div>
                        
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 control-label">mac_id</label>
                            <div class="col-md-9"><input type="text" class="form-control " id="condition_mac" ></div>
                        </div>
                        
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 control-label">地址名称</label>
                            <div class="col-md-9"><input type="text" class="form-control " id="condition_address" ></div>
                        </div>
    ...
    <div class="modal fade" id="showBeacondetail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">×</button>
                    <div><h3>设备详细信息</h3></div>
                </div>
                ...
                <div class="modal-body" >
                        ...
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 col-md-offset-1 control-label">设备mac_id</label>
                            <div class="col-md-6 "><input type="text" class="form-control" disabled id="mac_id1"></div>
                        </div>

                        <div class="form-group form-group-sm">
                            <label class="col-md-3 col-md-offset-1 control-label">设备uuid</label>
                            <div class="col-md-6"><input type="text" class="form-control" disabled id="uuid1"></div>
                        </div>
                        
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 col-md-offset-1 control-label">设备major</label>
                            <div class="col-md-6"><input type="text" class="form-control" disabled id="major1"></div>
                        </div>
                        
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 col-md-offset-1 control-label">设备minor</label>
                            <div class="col-md-6"><input type="text" class="form-control" disabled id="minor1"></div>
                        </div>
                        
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 col-md-offset-1 control-label">绑定URL编号</label>
                            <div class="col-md-6"><input type="text" class="form-control" disabled id="mes_id1"></div>
                        </div>
                        
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 col-md-offset-1 control-label">绑定页面标题</label>
                            <div class="col-md-6"><input type="text" class="form-control" disabled id="mes_title1"></div>
                        </div>
                        
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 col-md-offset-1 control-label">绑定页面URL</label>
                            <div class="col-md-6">
                            	<div class="input-group">
     								<input type="text" class="form-control" id="mes_content1" name="content" disabled>
                        ...
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 col-md-offset-1 control-label">绑定页面状态</label>
                            <div class="col-md-6"><input type="text" class="form-control" disabled id="mes_status1"></div>
                        </div>
                           
						
						<div class="form-group form-group-sm">
                            <label class="col-md-3 col-md-offset-1 control-label">设备隶属项目</label>
                            <div class="col-md-6"><input type="text" class="form-control" disabled id="pro_title1"></div>
                        </div>
