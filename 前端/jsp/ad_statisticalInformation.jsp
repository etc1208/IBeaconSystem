      ...
      <div class="row">
        ...
        <div id="content" class="col-lg-10 col-sm-10">
          <!-- content starts -->
            ...
            <div id = "statistic1" class="col-md-12">
            </div>
                ...
                <div class="modal-body" >
                	<form class="form-horizontal" role="form">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div>
                            	<span id='statisticTime'>
                            	<label class="radio-inline col-md-2">
                    				<input type="radio" name="statisticTime" id="time5" value="5" checked> 自行选择
                				</label>
                            	<label class="radio-inline col-md-2">
                    				<input type="radio" name="statisticTime" id="time7" value="7" > 最近7日
                				</label>
                				<label class="radio-inline col-md-2">
                    				<input type="radio" name="statisticTime" id="time10" value="10"> 最近10日
                    	  	  	</label>
                				<label class="radio-inline col-md-2">
                    				<input type="radio" name="statisticTime" id="time15" value="15"> 最近15日
                				</label>
                				
                           	</span>
                            </div>
                            <div class="col-md-9 col-md-offset-3"  id="timechoose">
                ...
                <div class="modal-body" >
                	<form class="form-horizontal" role="form">
                        ...
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 control-label">时间</label>
                            <div>
                            	<span id='statisticTime3'>
                            	<label class="radio-inline col-md-2">
                    				<input type="radio" name="statisticTime3" id="time53" value="5" checked> 自行选择
                				</label>
                            	<label class="radio-inline col-md-2">
                    				<input type="radio" name="statisticTime3" id="time73" value="7" > 最近7日
                				</label>
                				<label class="radio-inline col-md-2">
                    				<input type="radio" name="statisticTime3" id="time103" value="10"> 最近10日
                    	  	  	</label>
                				<label class="radio-inline col-md-2">
                    				<input type="radio" name="statisticTime3" id="time153" value="15"> 最近15日
                				</label>
                				
                           	</span>
                            </div>
                            <div class="col-md-9 col-md-offset-3" id="timechoose2">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" >
                	<form class="form-horizontal" role="form">
                        ...
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 control-label">URL编号</label>
                            <div class="col-md-9"><input type="text" class="form-control validate_specialCharacter" id="condition_url_mesid"></div>
                        </div>
                        ...
                        <div class="form-group form-group-sm">
                         ...
                         <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-9"><input type="text" class="form-control validate_specialCharacter" id="condition_url_otherinfo"></div>
                        </div> 
                        
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 control-label">时间</label>
                            <div>
                            	<span id='statisticTime2'>
                            	<label class="radio-inline col-md-2">
                    				<input type="radio" name="statisticTime2" id="time52" value="5" checked> 自行选择
                				</label>
                            	<label class="radio-inline col-md-2">
                    				<input type="radio" name="statisticTime2" id="time72" value="7" > 最近7日
                				</label>
                				<label class="radio-inline col-md-2">
                    				<input type="radio" name="statisticTime2" id="time102" value="10"> 最近10日
                    	  	  	</label>
                				<label class="radio-inline col-md-2">
                    				<input type="radio" name="statisticTime2" id="time152" value="15"> 最近15日
                				</label>
                				
                           	</span>
                            </div>
                            <div class="col-md-9 col-md-offset-3" id="timechoose3">
