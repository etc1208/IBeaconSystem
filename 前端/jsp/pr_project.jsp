...
<html lang="en">
  ...
  <body>
    ...
    <div class="modal fade" id="projectDetailsModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">×</button>
                ...
                <div class="modal-body" >
                 <form class="form-horizontal" role="form">
                    <div class="form-group form-group-sm">
                        <label class="col-md-5 control-label">项目使用Beacon数目</label>
                        <div class="col-md-7"><input type="text" class="form-control" id="projectDetails_beacon" disabled></div>
                    </div>
                    <div class="form-group form-group-sm">
                        <label class="col-md-5 control-label">项目使用ID数目</label>
                        <div class="col-md-7"><input type="text" class="form-control" id="projectDetails_ID" disabled></div>
                    </div>
                    <div class="form-group form-group-sm">
                        <label class="col-md-5 control-label">项目使用URL数目</label>
                        <div class="col-md-7"><input type="text" class="form-control" id="projectDetails_url" disabled></div>
                    </div>
                 <form>
                </div>
                <div class="modal-footer">
