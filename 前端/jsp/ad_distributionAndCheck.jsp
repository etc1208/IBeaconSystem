                ...
                <div class="box col-md-12" style="margin-top:20px">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-list-alt"></i>  设备分配管理</h2> 
                            <button type="button" class="btn btn-success btn-sm" id='uploadExcelBtn'><i class="glyphicon glyphicon-search"></i> 上传设备绑定Excel</button>                         
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">上传设备绑定Excel</h4>          
            </div>
           <form role="form" action="url!add" method="post" id="uploadExcel_form" >
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" id='closeUploadExcelModal' data-dismiss="modal">关闭</button>
