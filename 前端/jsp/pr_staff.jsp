...
<html lang="en">
  ...
  <body>
          ...
          <!-- content starts -->
                ...
                <div class="box col-md-12" style="margin-top:20px">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-user"></i>  代理资源管理</h2>
                            <div class="box-icon">
            ...
            <div class="row">
            	<div class="box col-md-12" style="margin-top:20px">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
            				<h2><i class="glyphicon glyphicon-user"></i>权限归属查看</h2>
            				<div class="box-icon">
                                <button class='btn btn-success' id="sSession" onclick="showSession()">查看权限</button>
                            </div>
            			</div>
            			
            			<div class="box-content" id="test">

                            <table class="table table-striped table-bordered table-condensed" id="staff2table">
                                <!--<table class="table table-striped table-bordered bootstrap-datatable datatable responsive" id="proxyTable">-->
                                <thead>
                                <tr>
                                    <th>用户ID</th>
	...
	<div class="modal fade" id="showSession" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="">
		<div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">×</button>
                    <div id="head"><h3 >查看权限归属</h3></div>
                </div>
                <div class="modal-body" >
                	...
                	<form class="form-horizontal" role="form">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-6"><input type="text" class="form-control" id="uuids"></div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 control-label">major</label>
                            <div class="col-md-6"><input type="text" class="form-control validate_number" id="majors"></div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label class="col-md-3 control-label">minor:</label>
                            <div class="col-md-3"><input type="text" class="form-control validate_number validate_notNull"  id="value0s"></div>
                        	<label class="col-md-1 control-label">至</label>
                            <div class="col-md-3"><input type="text" class="form-control validate_number validate_notNull "  id="value1s"></div>
                        </div>
                 ...
                 <div class="modal-footer">
                    ...
                    <button id="showS" class="btn btn-default">提交</button>
                </div>
              </div>
         </div>
                ...
                <div class="modal-body" >
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-9"><input type="text" class="form-control validate_notNull validate_specialCharacter validate_NumOrLetter" id="staff_id"></div>
                            <!-- Lynn改userID -->
                        </div>
    ...
    <div class="modal fade bs-example-modal-lg" id="show_one" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="">
        <!-- Lynn改成大模态框 -->
                    ...
                    <form class="form-horizontal" role="form" >
                        ...
                        <div class="form-group form-group-sm">
							...
							<div class="collapse" id="collapseInfo">
  								<div class="well">
    								<table class="table table-bordered table-condensed" id="collapse2_table">                             
                                		<thead>
                               				<tr>
                                 				<th>uuid</th>
                                    			<th>major</th>
